...
import { Activity, LayoutDashboard, LogOut, PanelLeft, Users, Settings, Zap, TrendingUp, Share2, Trophy, Clock, Briefcase, Coins, Copy, Image, RefreshCw, Webhook, Bot } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Zap, label: "Exchange Integration", path: "/exchange-integration" },
  { icon: TrendingUp, label: "Backtesting", path: "/backtesting" },
  { icon: Bot, label: "Paper Monitor", path: "/paper-trading-monitoring" },
  ...
  { icon: RefreshCw, label: "Rebalancing", path: "/portfolio-rebalancing" },
  ...
  { icon: Webhook, label: "Webhooks", path: "/webhook-integrations" },
