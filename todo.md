...
- [ ] Добавить триггеры для новых позиций
- [ ] Добавить уведомления при достижении целей
- [ ] Реализовать уведомления о рисках
...
- [ ] Создать функцию для генерации PDF
- [ ] Интегрировать в reportExportRouter
- [ ] Добавить кнопку экспорта в PDF
- [ ] Написать тесты для PDF экспорта
