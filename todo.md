...
- [ ] Создать alertsRouter для управления алертами
- [ ] Реализовать фоновый job для проверки метрик
- [ ] Добавить триггеры для рисков и целей
- [ ] Интегрировать с notificationRouter
- [ ] Написать тесты для алертов
- [ ] Протестировать в браузере

## Phase 90: Strategy History с графиками
- [ ] Создать историческую таблицу в БД
- [ ] Добавить процедуру для сохранения снимков метрик
- [ ] Создать компонент StrategyHistory.tsx
- [ ] Добавить графики эволюции метрик
- [ ] Написать тесты для истории
- [ ] Протестировать в браузере

## Phase 91: AI рекомендации для оптимизации
- [ ] Создать recommendationsRouter
- [ ] Интегрировать LLM для анализа метрик
- [ ] Реализовать процедуру generateRecommendations
- [ ] Добавить UI для отображения рекомендаций
- [ ] Написать тесты для рекомендаций
- [ ] Протестировать в браузере
