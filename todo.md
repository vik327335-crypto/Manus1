...
- [ ] Реализовать систему правил для автоматических действий
- [ ] Создать компонент AutomationRules для настройки правил
- [ ] Реализовать экспорт отчётов в PDF с AI анализом
- [ ] Добавить функцию генерации PDF отчётов
- [ ] Написать тесты для новых функций
- [ ] Протестировать и сохранить финальный checkpoint
