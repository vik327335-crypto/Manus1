...
- [ ] Реализовать импорт позиций из XT.COM
- [ ] Добавить синхронизацию портфеля с XT.COM
- [ ] Создать UI для подключения XT.COM
- [ ] Добавить отображение балансов с XT.COM
- [ ] Реализовать историю сделок с XT.COM
- [ ] Написать тесты для XT.COM интеграции
