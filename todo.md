...
- [ ] Создать таблицу traders в БД (name, description, win_rate, total_trades)
- [ ] Добавить страницу Traders с рейтингом и статистикой
- [ ] Реализовать функцию копирования сделок трейдера
- [ ] Добавить отслеживание скопированных сделок
- [ ] Создать tRPC роутер для управления социальной торговлей
- [ ] Написать тесты для социальной торговли

## Phase 71: Мобильное приложение React Native
- [ ] Инициализировать React Native проект (Expo)
- [ ] Создать базовую навигацию и layout
- [ ] Реализовать экран Dashboard с портфелем
- [ ] Добавить экран Scanner с поиском активов
- [ ] Реализовать экран Portfolio с управлением позициями
- [ ] Добавить push-уведомления о значительных изменениях
- [ ] Создать экран Settings с управлением API ключами
- [ ] Написать тесты для мобильного приложения
