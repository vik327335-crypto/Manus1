...
- [ ] Написать тесты для функций экспорта
- [ ] Протестировать экспорт в браузере

## Phase 84: WebSocket интеграция для real-time обновлений
- [ ] Настроить WebSocket сервер для live обновлений
- [ ] Добавить подписку на обновления метрик в frontend
- [ ] Реализовать auto-refresh при появлении новых сделок
- [ ] Написать тесты для WebSocket логики
- [ ] Протестировать live обновления

## Phase 85: Сравнение стратегий по периодам
- [ ] Добавить процедуру getStrategyComparisonByPeriods в backend
- [ ] Создать UI компонент для выбора периодов
- [ ] Реализовать график сравнения по периодам
- [ ] Написать тесты для сравнения
