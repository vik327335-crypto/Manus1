...
export const paperTradingMonitors = mysqlTable("paper_trading_monitors", {
  ...
  lastAlertKind: varchar("lastAlertKind", { length: 32 }),
...
export const paperTradingMonitorRuns = mysqlTable("paper_trading_monitor_runs", {
  ...
  dataFreshness: mysqlEnum("dataFreshness", ["fresh", "stale"]),
  candleAgeMinutes: int("candleAgeMinutes"),
  equityInvariantDeltaCents: int("equityInvariantDeltaCents"),
  diagnosticFlags: json("diagnosticFlags").$type<string[]>(),
